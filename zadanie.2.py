...
library1 = Library("Paryz", "Oliwna", "12345", "9:00 AM - 5:00 PM", "123-456-7890")
library2 = Library("Gdansk", "Pomorska", "54321", "10:00 AM - 6:00 PM", "987-654-3210")

employee1 = Employee("John", "Doe", "2022-01-01", "1990-05-15", "Moskow", "Aleja", "12345", "111-222-3333")
employee2 = Employee("Jane", "Smith", "2022-02-01", "1985-08-20", "Wroclaw", "Pocztowa", "12345", "444-555-6666")
employee3 = Employee("Bob", "Johnson", "2022-03-01", "1995-03-10", "Poznan", "Murowana", "54321", "777-888-9999")
...
book4 = Book(library2, "2023-04-04", "Stun", "Lawin", 300)
book5 = Book(library2, "2021-05-05", "Katrine", "Powder", 260)

student1 = Employee("Alice", "Johnson", "2022-01-15", "2000-10-05", "Katowice", "Krasickiego", "12345", "999-000-1111")
student2 = Employee("Bob", "Miller", "2022-02-20", "1998-12-15", "New York", "Padeniu", "54321", "222-333-4444")
student3 = Employee("Charlie", "Brown", "2022-03-25", "2001-06-20", "Berlin", "Grossestrasse", "12345", "555-666-7777")
